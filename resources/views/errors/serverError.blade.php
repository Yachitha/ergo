...
<div class="container" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50% ); text-align: center; margin-left: auto; margin-right: auto;">
    <div class="row">
        <div class="col-lg-6 offset-3">
            <h2><i class="fa fa-exclamation-triangle"></i>Looks like we are having some server issues!</h2>
            <hr>
            <p>Try again by refreshing the page.</p>
            <p>Any problems, feel free to contact us.</p>
            <a href="/landing" class="btn btn-dark">Home</a>
        </div>
    </div>
</div>
